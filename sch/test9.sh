...
# SHL, ASP, NDP, and DR1-DR5; primarily to facilitate development and
...
python3 mch_minimal_server.py --accept-all NDP 127.0.0.1 1743 1742 &
...
# Create DR MIB initialization files 
...
mcic    ASP
mibinit NDP 127.0.0.1 1742 1743
mcic    NDP
